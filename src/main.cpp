...
const string strMessageMagic = "Blockbeeper Signed Message:\n";
...
{
        nStakeMinAge  = .0009 * 60 * 60; //6 hours
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 1 * COIN; //premine for SWAP old coins
    }
        else if(pindexBest->nHeight >= 1  && pindexBest->nHeight <= 100)
    {
        nSubsidy = 1 * COIN;
    }
...
{
    RenameThread("Blockbeeper-loadblk");
